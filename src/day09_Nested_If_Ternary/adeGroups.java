...
public class adeGroups {
    public static void main(String[] args) {
       ...
       String ageGroup2 = (age<=3 && age>0) ? "Baby" : (age>=3 && age <=5)? "Toddler" :(age >= 6 && age <= 9)? "Kid"
               :(age>=10 && age <=12)? "pre-teen" : (age>=13 && age <=17)? "Teenager" : (age>=18 && age <=20)?
               "Young Adult" : (age >=21 && age <=39)? "Adult" : (age>=40 && age <=49)? "Young Midle-Aged Adult"
