...
public class StringClassMethods {
    public static void main(String[] args) {
        ...
        char ch2 = str1.charAt(4);// space

        System.out.println(ch2);

/*
        String name = "Guljanat come to Berlin. But her bags left to airport.";
       int ind = name.lastIndexOf("left");

        String srt = name.replace("left","deft"); //GulDanat
                srt = name.replace("D", "j");
      ...
      //  System.out.println(ch3);
        ...
        String srttt = "A sentence is a group of words that are put together to mean something.";
         int maxIndexOfSt = srttt.length()-1;
        System.out.println(maxIndexOfSt);
        ...
        String word1 = "Kazakhstan";
        String word2 = " Republic";
